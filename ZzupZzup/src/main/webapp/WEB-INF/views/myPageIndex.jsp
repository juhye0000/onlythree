								...
								<div class="profile-card-body">
									<div class="d-flex flex-column align-items-center text-center">
										...
										<div class="mt-3">
											...
											<p class="text-muted font-size-sm">Bay Area, San rancisco, CA</p> -->
							...
							<div class="profile-card mt-3">
								<ul class="list-group list-group-flush">
									...
									<li
										class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
										<h6 class="mb-0">
											<a href="mypage_recent_list"> 최근 본 레시피 </a>
										</h6>
									</li>
									<li
										class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
							...
							<div class="profile-card mb-3">
								<div class="profile-card-body">
									...
									<jsp:include page="${page}.jsp" />
										<!-- 들어가는 페이지 목록 (jsp)
											마이페이지 홈	myPage/myRecipeList
											MY 레시피		myRecipeList
											MY선호도조사	myPreferList
											스크랩레시피	myPage_scrapList
											최근본레시피	
											내정보확인		myPage_profile
												내정보수정	mypage_profile_update
										-->

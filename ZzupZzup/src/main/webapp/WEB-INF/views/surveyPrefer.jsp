		...
		<div class="signup-content">
			<div id ="fullform">
				<div class="row mypage-banner-div">
					<div class="col-lg-8 mypage-banner-text"> 선호 음식 재료 조사	</div>
					<div class="col-lg-4"><img class="mypage-banner-img" src="image/preferSurvey.png" alt="preferlist"></div>
				</div>
					<form method="POST" class="register-form" id="register-form" action="./myPreferSave">
					<!-- 선호음식1 -->
					<div id ="preferIngre">

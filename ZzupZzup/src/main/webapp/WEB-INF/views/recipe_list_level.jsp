...
$(function(){
	$(".sel").click(function() {
		var LEVEL_TITLE = $(this).attr("value");
...
<body>
	...
	<h1 class="mt-4 mb-3">
		난이도별 레시피 : <small>${LEVEL_TITLE}</small>
	</h1>
	<form action="./levelRecipeList" method="post" id="recipe_list">
		<div class="breadcrumb">
			<input type="hidden" id="LEVEL_TITLE" name="LEVEL_TITLE" />
			<table>
				<tr>
					<td><input type="button" class="sel" value="전체" /></td>
					<td><input type="button" class="sel" value="상" /></td>
					<td><input type="button" class="sel" value="중" /></td>
					<td><input type="button" class="sel" value="하" /></td>
				</tr>
			</table>
		</div>
		<br>

...
<body>
	...
	<h1 class="mt-4 mb-3">
		재료별 레시피 : <small>${INGREDIENT_CATEGORY}</small>
	</h1>
	<form action="./ingredientRecipeList" method="post" id="recipe_list">
		<div class="breadcrumb">
			<input type="hidden" id="INGREDIENT_CATEGORY"
				name="INGREDIENT_CATEGORY" />
			<table>
				<tr>
					<td><input type="button" class="sel" value="전체" /></td>
					<td><input type="button" class="sel" value="곡류" /></td>
					<td><input type="button" class="sel" value="식량작물" /></td>
					<td><input type="button" class="sel" value="육류" /></td>
					<td><input type="button" class="sel" value="난류" /></td>
					<td><input type="button" class="sel" value="유제품" /></td>
					<td><input type="button" class="sel" value="해산물" /></td>
					<td><input type="button" class="sel" value="해조류" /></td>
					<td><input type="button" class="sel" value="과일류" /></td>
				</tr>
				<tr>
					<td><input type="button" class="sel" value="견과류" /></td>
					<td><input type="button" class="sel" value="버섯류" /></td>
					<td><input type="button" class="sel" value="가공식품류" /></td>
